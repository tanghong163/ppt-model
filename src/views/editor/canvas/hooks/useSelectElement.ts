 ...
 * @Date: 2022-10-13 15:27:26
 * @LastEditors: sugar th14200143@163.com
 * @LastEditTime: 2022-10-13 15:41:28
 * @FilePath: \ppt-model\src\views\editor\canvas\hooks\useSelectElement.ts
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
import { Ref } from 'vue';
import { uniq } from 'lodash';
import { storeToRefs } from 'pinia';
import { useMainStore, useKeyboardStore } from '@/stores';
import { PPTElement } from '@/types/slides';

export default (elementList: Ref<PPTElement[]>, moveElement: (e: MouseEvent | TouchEvent, element: PPTElement) => void) => {
